<template>
  <div id="animize-forbidden" class="flex justify-center flex-col">
    <img alt="Forbidden" class="item flex-wrap max-w-[300px] max-h-[300px]" src="~/assets/icon/astronaut.png">
    <div class="item w-64">
